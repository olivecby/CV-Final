  ...
  for (int i = 0; i < argc; i++) {
	...
	/*if (!strcmp(argv[i], "-svdTest")) {
	  ...
	  return 0;
		...
		char inputName[100] = "../../videoinput/%07d.jpg";
		char outputName[100] = "../../videooutput/output%07d.jpg";

		char upperLeftName[100] = "../../markers/upperleft.jpg";
		char upperRightName[100] = "../../markers/upperright.jpg";
		char lowerLeftName[100] = "../../markers/lowerleft.jpg";
		char lowerRightName[100] = "../../markers/lowerright.jpg";
		...
		for (int i = 1; i < end; i++)
		{
			...
			R2Point upperLeftMarker = currentImage->detectFeature(upperLeftMarkerImage);
			R2Point upperRightMarker = currentImage->detectFeature(upperRightMarkerImage);
			R2Point lowerLeftMarker = currentImage->detectFeature(lowerLeftMarkerImage);
			R2Point lowerRightMarker = currentImage->detectFeature(lowerRightMarkerImage);
